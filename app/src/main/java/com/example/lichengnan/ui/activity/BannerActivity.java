...
import com.example.lichengnan.banner.BannerLayoutManager;
import com.example.lichengnan.widget.InterceptRelativeLayout;
...
public class BannerActivity extends AppCompatActivity {
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(EyepetizerApplication.context).inflate(R.layout.item_banner, parent, false);
    ...
    class MyNewsAdapter extends RecyclerView.Adapter<MyNewsAdapter.ViewHolder> {
        ...
        @Override
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(EyepetizerApplication.context).inflate(R.layout.item_banner_news, parent, false);
            return new ViewHolder(view);
        }
