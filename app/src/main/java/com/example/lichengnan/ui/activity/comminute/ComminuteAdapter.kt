...
package com.example.lichengnan.ui.activity.comminute
...
class ComminuteAdapter(val fragment: CommuniteFragment, var dataList: List<CommunityRecommend.Item>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    inner class SquareCardOfCommunityContentAdapter(val fragment: CommuniteFragment, var dataList: List<CommunityRecommend.ItemX>) :
    ...
    inner class SquareCardOfCommunityContentItemDecoration(val fragment: CommuniteFragment) : RecyclerView.ItemDecoration() {
     ...
     * 社区整个垂直列表的间隙
     */
    class ItemDecoration(val fragment: CommuniteFragment) : RecyclerView.ItemDecoration() {
