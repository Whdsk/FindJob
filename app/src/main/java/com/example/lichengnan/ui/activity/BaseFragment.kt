...
import com.example.lichengnan.extension.showDialogShare
import com.example.lichengnan.ui.callback.RequestLifecycle
...
open class BaseFragment : Fragment(), RequestLifecycle {
    ...
    protected fun showDialogShare(shareContent: String) {
        if (this.activity is AppCompatActivity) {
            showDialogShare(this.activity as AppCompatActivity, shareContent)
        }
    }
}