...
package com.example.lichengnan.ui.ugc
...
class UgcDetailAdapter(val activity: UgcDetailActivity, var dataList: List<CommunityRecommend.Item>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun getItemViewType(position: Int): Int {
        ...
        return when (item.type) {
            ComminuteAdapter.STR_COMMUNITY_COLUMNS_CARD -> {
                if (item.data.dataType == ComminuteAdapter.STR_FOLLOW_CARD_DATA_TYPE) ComminuteAdapter.FOLLOW_CARD_TYPE
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = when (viewType) {
        ComminuteAdapter.FOLLOW_CARD_TYPE -> FollowCardViewHolder(R.layout.item_ugc_detail.inflate(parent))
        ...
        when (holder) {
            is FollowCardViewHolder -> {
                ...
                when (item.data.content.type) {
                    ComminuteAdapter.STR_VIDEO_TYPE -> {
                    ...
                    ComminuteAdapter.STR_UGC_PICTURE_TYPE -> {
