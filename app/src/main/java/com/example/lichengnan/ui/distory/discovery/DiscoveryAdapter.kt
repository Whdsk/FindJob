...
package com.example.lichengnan.ui.distory.discovery
...
import com.example.lichengnan.network.view.GridListItemDecoration
        ...
        when (holder) {
            ...
            is AutoPlayVideoAdViewHolder -> {
                item.data.detail?.run {
                    ...
                    HomeAdapter.startAutoPlay(fragment.activity, holder.videoPlayer, position, url, imageUrl, CommuniteAdapter.TAG, object : GSYSampleCallBack() {
