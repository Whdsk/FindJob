...
public class ItemTouchHelperCallback<T> extends ItemTouchHelper.Callback {
    ...
    public ItemTouchHelperCallback(@NonNull RecyclerView.Adapter adapter, @NonNull List<T> dataList, OnSlideListener listener) {
        this.adapter = checkIsNull(adapter);
        this.dataList = checkIsNull(dataList);
    ...
    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        if (mListener != null) {
            mListener.onSlided(viewHolder, direction == ItemTouchHelper.LEFT ? ItemConfig.SLIDED_LEFT : ItemConfig.SLIDED_RIGHT);
        }
